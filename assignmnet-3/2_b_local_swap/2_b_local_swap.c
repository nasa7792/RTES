...
Original authourt -Sam Siewert, July 2016

Code modified vy- Nalin Saxena
A simple example to show how to write thread safe reentrant functions with local variables
The counter example is in 2_b_global_swap
*/
...
int b=20;
    int temp = a;
     ...
     usleep(rand() % 1000);  // some random delay
    a = b;
     usleep(rand() % 1000);
    b = temp;
...
int main (int argc, char *argv[])
{
  ...
  //printf("\n final value of unsafe global %d=",unsafe_global);
   printf("\nTEST COMPLETE\n");
}
