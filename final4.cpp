...
int main(){
    ...
    Sequencer seq;
    seq.addService(camera_capture_service,     1, 97,  256, 1, 1);
    seq.addService(red_laser_detect_and_show,  1, 96,  128, 2, 2);
    seq.addService(service3_thread,            1, 95,  64, 3, 3);
    seq.addService(service4_motor_control,     1, 98,  32, 4, 4);
